...
public class WorkPool {
	...
	int nWaiting = 0; // nr de thread-uri worker care sunt blocate asteptand un
						// task
	public boolean ready = false; // daca s-a terminat complet rezolvarea
									// problemei

	LinkedList<Solution> tasks = new LinkedList<Solution>();
	 ...
	 *         terminat
	 */
	public synchronized Solution getWork() {
	 ...
	 */
	synchronized void putWork(Solution sp) {
		tasks.add(sp);
